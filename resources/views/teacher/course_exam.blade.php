         ...
         <div class="col-12">
            <div class="mt-10">
               <div class="card_dash_right1">
                  <a type="button" class="create_btn_dash course_details btn btn-danger" href="{{url('add_new_exam')}}">ADD NEW</a>
               </div>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="text-center">
                                <a type="button" class="btn btn-warning" href="{{url('add_question')}}">ADD QUE</a>
                             </td>
                              <td class="text-center">
