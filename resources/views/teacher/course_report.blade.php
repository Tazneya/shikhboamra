                     ...
                     <table class="table ucp-table" id="content-table">
                        <thead class="thead-s">
                           <tr>
                              ...
                              <th class="text-center" scope="col">Total Enrolled</th>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="text-center">{{ count($data->enroll_count) }}</td>

                              <td class="text-center">
                                 <a type="button" class="btn btn-warning" href="course_report/student_details/{{ $data->id }}">Show Student Deatils</a>
                              </td>
