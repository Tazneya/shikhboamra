...
<head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('sourcefile_home')}}/images/fav.png">
        <!-- Bootstrap v4.4.1 css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/bootstrap.min.css">
        <!-- font-awesome css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/font-awesome.min.css">
        <!-- animate css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/animate.css">
        <!-- owl.carousel css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/owl.carousel.css">
        <!-- slick css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/slick.css">
        <!-- off canvas css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/off-canvas.css">
        <!-- linea-font css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/fonts/linea-fonts.css">
        <!-- flaticon css  -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/fonts/flaticon.css">
        <!-- magnific popup css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/magnific-popup.css">
        <!-- Main Menu css -->
        <link rel="stylesheet" href="{{asset('sourcefile_home')}}/css/rsmenu-main.css">
        <!-- spacing css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/rs-spacing.css">
        <!-- style css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/style.css"> <!-- This stylesheet dynamically changed from style.less -->
        <!-- responsive css -->
        <link rel="stylesheet" type="text/css" href="{{asset('sourcefile_home')}}/css/responsive.css">
        <!--[if lt IE 9]>
    ...
    <body class="home-style3">
        ...
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class='loader-icon'>
                    <img src="{{asset('sourcefile_home')}}/images/pre-logo.png" alt="">
                </div>
            </div>
        </div>
            ...
            <header id="rs-header" class="rs-header">
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index.html"><img src="{{asset('sourcefile_home')}}/images/logo-dark.png" alt="logo"></a>
                    </div>
                    ...
                    <div class="offcanvas-gallery">
                        <div class="gallery-img">
                            <a class="image-popup" href="{{asset('sourcefile_home')}}/images/gallery/1.jpg"><img src="{{asset('sourcefile_home')}}/images/gallery/1.jpg" alt=""></a>
                        </div>
                        <div class="gallery-img">
                            <a class="image-popup" href="{{asset('sourcefile_home')}}/images/gallery/2.jpg"><img src="{{asset('sourcefile_home')}}/images/gallery/2.jpg" alt=""></a>
                        </div>
                        <div class="gallery-img">
                            <a class="image-popup" href="{{asset('sourcefile_home')}}/images/gallery/3.jpg"><img src="{{asset('sourcefile_home')}}/images/gallery/3.jpg" alt=""></a>
                        </div>
                        <div class="gallery-img">
                            <a class="image-popup" href="{{asset('sourcefile_home')}}/images/gallery/4.jpg"><img src="{{asset('sourcefile_home')}}/images/gallery/4.jpg" alt=""></a>
                        </div>
                        <div class="gallery-img">
                            <a class="image-popup" href="{{asset('sourcefile_home')}}/images/gallery/5.jpg"><img src="{{asset('sourcefile_home')}}/images/gallery/5.jpg" alt=""></a>
                        </div>
                        <div class="gallery-img">
                            <a class="image-popup" href="{{asset('sourcefile_home')}}/images/gallery/6.jpg"><img src="{{asset('sourcefile_home')}}/images/gallery/6.jpg" alt=""></a>
                        </div>
                    </div>
                    <div class="map-img">
                        <img src="{{asset('sourcefile_home')}}/images/map.jpg" alt="">
                    </div>
                ...
                <div class="container pt-90 md-pt-50">
                    <div class="banner-content pb-13">
                        ...
                        <div class="banner-image hidden-md">
                            <div id="stuff">
                                <div data-depth="0.3">
                                    <img src="{{asset('sourcefile_home')}}/images/banner/bnr3-top.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="2" data-md-device-nav="false" data-md-device-dots="true">
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/1.png" alt="">
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/2.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/3.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/4.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/5.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/6.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/7.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/8.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/9.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="testi-item">
                            <div class="row y-middle no-gutter">
                                <div class="col-md-4">
                                    <div class="user-info">
                                        <img src="{{asset('sourcefile_home')}}/images/testimonial/style3/10.png" alt="">
                                        <h4 class="name">Saiko Najran</h4>
                                        <span class="designation">Student</span>
                                        <ul class="ratings">
                                            <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="row y-middle">
                        <div class="col-lg-4 md-mb-20">
                            <div class="footer-logo md-text-center">
                                <a href="index.html"><img src="{{asset('sourcefile_home')}}/images/logo.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4 md-mb-20">
                            <div class="copyright text-center md-text-left">
                                <p>&copy; 2020 All Rights Reserved. Developed By <a href="#">shikhboamra</a></p>
                            </div>
                        </div>
        ...
        <!-- modernizr js -->
        <script src="{{asset('sourcefile_home')}}/js/modernizr-2.8.3.min.js"></script>
        <!-- jquery latest version -->
        <script src="{{asset('sourcefile_home')}}/js/jquery.min.js"></script>
        <!-- Bootstrap v4.4.1 js -->
        ...
        <!-- owl.carousel js -->
        <script src="{{asset('sourcefile_home')}}/js/owl.carousel.min.js"></script>
        <!-- Slick js -->
        <script src="{{asset('sourcefile_home')}}/js/slick.min.js"></script>
        <!-- isotope.pkgd.min js -->
        <script src="{{asset('sourcefile_home')}}/js/isotope.pkgd.min.js"></script>
        <!-- imagesloaded.pkgd.min js -->
        <script src="{{asset('sourcefile_home')}}/js/imagesloaded.pkgd.min.js"></script>
        <!-- wow js -->
        ...
        <!-- contact form js -->
        <script src="{{asset('sourcefile_home')}}/js/contact.form.js"></script>
        <!-- main js -->
        <script src="{{asset('sourcefile_home')}}/js/main.js"></script>
    </body>

<!-- Mirrored from keenitsolutions.com/products/html/educavo/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Aug 2021 13:39:32 GMT -->
</html>
